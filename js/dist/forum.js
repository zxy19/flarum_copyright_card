...
var CopyrightConfigModal = /*#__PURE__*/function (_Modal) {
  ...
  _proto.title = function title() {
    return flarum_forum_app__WEBPACK_IMPORTED_MODULE_4___default().translator.trans('xypp-copyright-card.forum.config.title');
  };
...
var CopyrightPiece = /*#__PURE__*/function (_Component) {
  ...
  _proto.content = function content() {
    ...
    if (this.attrs.data.other) {
      items.add("other", m("div", null, this.attrs.data.other));
    }
    return items;
  };
